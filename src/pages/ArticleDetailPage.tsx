            ...
            <div className="px-[120px] py-16">
                ...
                <div className="mb-12 border-b border-slate-200 pb-8">
                    ...
                    <div className="flex flex-wrap items-center gap-4">
                        {/* Category Badge */}
                        <div className="inline-flex rounded-full bg-[#fef2f2] px-4 py-2 text-sm font-semibold text-[#e55c34]">
                            {article.category}
                        </div>
                ...
                <div className="flex gap-8 w-full justify-between ">
                    ...
                    <div className="w-[70%] shrink-0">
                        <div className="space-y-8">
                            ...
                            <div className="space-y-4">
                                {/* Heading */}
                                <h2 className="text-[30px] font-normal leading-[30px] text-[#3d3d3d]">
                    ...
                    <aside className="flex-1 shrink-0">
                        <div className="space-y-6">
                            <h2 className="text-2xl font-bold text-black">Bài viết cùng chủ đề</h2>
